...
static const _GetGPS_Request_type_support_symbol_names_t _GetGPS_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, final_pipeline, srv, GetGPS_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, final_pipeline, srv, GetGPS_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, final_pipeline, srv, GetGPS_Request)() {
  return &::final_pipeline::srv::rosidl_typesupport_c::GetGPS_Request_message_type_support_handle;
}
...
static const _GetGPS_Response_type_support_symbol_names_t _GetGPS_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, final_pipeline, srv, GetGPS_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, final_pipeline, srv, GetGPS_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, final_pipeline, srv, GetGPS_Response)() {
  return &::final_pipeline::srv::rosidl_typesupport_c::GetGPS_Response_message_type_support_handle;
}
...
static const _GetGPS_Event_type_support_symbol_names_t _GetGPS_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, final_pipeline, srv, GetGPS_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, final_pipeline, srv, GetGPS_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, final_pipeline, srv, GetGPS_Event)() {
  return &::final_pipeline::srv::rosidl_typesupport_c::GetGPS_Event_message_type_support_handle;
}
...
static const _GetGPS_type_support_symbol_names_t _GetGPS_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, final_pipeline, srv, GetGPS)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, final_pipeline, srv, GetGPS)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, final_pipeline, srv, GetGPS)() {
  return &::final_pipeline::srv::rosidl_typesupport_c::GetGPS_service_type_support_handle;
}
